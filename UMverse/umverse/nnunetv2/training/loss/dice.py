...
class MemoryEfficientSoftDiceLoss(nn.Module):
    def __init__(self,weight, apply_nonlin: Callable = None, batch_dice: bool = False, do_bg: bool = True, smooth: float = 1.,
                 ddp: bool = True):
        """
    ...
    def forward(self, x, y, loss_mask=None):
        ...
        weighted_dice = dc * self.weight
        dic = weighted_dice.mean()
        return -dic
